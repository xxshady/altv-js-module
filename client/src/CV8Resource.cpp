...
void StartFile(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    v8::MaybeLocal<v8::Module> maybeMod = static_cast<CV8ResourceImpl*>(resource)->ResolveFile(
        path, v8::Local<v8::Module>(), resource->GetResource());
...
CV8ResourceImpl::CV8ResourceImpl(alt::IResource* resource, v8::Isolate* isolate) : V8ResourceImpl(isolate, resource)
{
    ...
    v8::Local<v8::Context> ctx =
        v8::Context::New(isolate, nullptr, v8::MaybeLocal<v8::ObjectTemplate>(), v8::MaybeLocal<v8::Value>(),
                         v8::DeserializeInternalFieldsCallback(), microtaskQueue.get());
...
std::vector<V8Helpers::EventCallback*> CV8ResourceImpl::GetWebSocketClientHandlers(
    alt::IWebSocketClient* webSocket, const std::string& name)
{
    std::vector<V8Helpers::EventCallback*> handlers;
...
std::vector<V8Helpers::EventCallback*> CV8ResourceImpl::GetRmlHandlers(alt::IRmlElement* element,
